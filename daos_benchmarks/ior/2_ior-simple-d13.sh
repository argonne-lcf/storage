...
echo -e "\n With Lustre Posix \n"
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth -genvall --no-vni ior -a posix -b 10G -t 1M -w -r -i 5 -v -C -e -o ./io.dat # Note the dot - Lustre
...
echo -e "\n With Lustre MPIO \n"
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni ior -a mpiio -b 10G -t 1M -w -r -i 5 -v -C -e -o ./io.dat # Note the dot - Lustre
lfs getstripe ./io.dat
rm ./io.dat
...
echo -e "\n With DAOS Posix Container POSIX  \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni ior -a posix -b 10G -t 1M -w -r -i 5 -v -C -e -o /tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

# With DAOS Posix Container POSIX 
echo -e "\n With DAOS Posix Container POSIX  \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni --env LD_PRELOAD=$DAOS_PRELOAD ior -a posix -b 10G -t 1M -w -r -i 5 -v -C -e -o /tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

# With DAOS Posix Container POSIX 
echo -e "\n With DAOS Posix Container POSIX  \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni --env LD_PRELOAD=/usr/lib64/libpil4dfs.so ior -a posix -b 10G -t 1M -w -r -i 5 -v -C -e -o /tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*
  

# With DAOS Posix Container MPIO
echo -e "\n With DAOS Posix Container MPIO \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni ior -a mpiio -b 10G -t 1M -w -r -i 5 -v -C -e -o daos:/tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

# With DAOS Posix Container DFS 
echo -e "\n With DAOS Posix Container DFS \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn -d 13 --cpu-bind=depth  -genvall --no-vni ior -a DFS --dfs.pool=$DAOS_POOL --dfs.cont=$DAOS_CONT --dfs.dir_oclass=S1 --dfs.oclass=SX --dfs.chunk_size=$((128*1024)) -b 10G -t 1M -w -r -i 5 -v -C -e -o /io.dat
rm /tmp/$DAOS_POOL/$DAOS_CONT/*
