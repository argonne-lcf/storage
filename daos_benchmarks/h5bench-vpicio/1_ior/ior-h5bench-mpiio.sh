...
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni ior -a mpiio -b 100K -t 1K -w -r -C -e -i 5 -v -o  ./io-small.dat # Note the dot - Lustre
lfs getstripe  ./io-small.dat
rm  ./io-small.dat

lfs setstripe -S 1M -c 32 $PBS_O_WORKDIR
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni ior -a mpiio -b 100K -t 1K -w -r -c -C -e -i 5 -v -o  ./io-small.dat # Note the dot - Lustre
lfs getstripe  ./io-small.dat
rm  ./io-small.dat

lfs setstripe -S 1M -c 32 $PBS_O_WORKDIR
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni ior -a mpiio -b 100K -t 1K -w -r -F -C -e -i 5 -v -o  ./io-small.dat # Note the dot - Lustre
lfs getstripe  ./io-small.dat
rm  ./io-small.dat

lfs setstripe -S 1M -c 32 $PBS_O_WORKDIR
lfs getstripe .
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni ior -a mpiio -b 100K -t 1K -w -r -c -F -C -e -i 5 -v -o  ./io-small.dat # Note the dot - Lustre
lfs getstripe  ./io-small.dat
rm  ./io-small.dat
...
export DAOS_CONT=kaus-iorh5bench-mpiiosmall-test-$nnodes
...
echo -e "\n With DAOS Posix Container MPIO \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni  ior -a mpiio -b 100K -t 1K -w -r -C -e -i 5 -v -o daos:/tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

 
# With DAOS Posix Container MPIO
echo -e "\n With DAOS Posix Container MPIO \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni  ior -a mpiio -b 100K -t 1K -w -r -c -C -e -i 5 -v -o daos:/tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

 
# With DAOS Posix Container MPIO
echo -e "\n With DAOS Posix Container MPIO \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni  ior -a mpiio -b 100K -t 1K -w -r -F -C -e -i 5 -v -o daos:/tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*

 
# With DAOS Posix Container MPIO
echo -e "\n With DAOS Posix Container MPIO \n"
mpiexec -np $((rpn*nnodes)) -ppn $rpn   --cpu-bind verbose,${binding[$i]}  -genvall --no-vni  ior -a mpiio -b 100K -t 1K -w -r -c -F -C -e -i 5 -v -o daos:/tmp/$DAOS_POOL/$DAOS_CONT/io.dat 
rm /tmp/$DAOS_POOL/$DAOS_CONT/*
